...
public class DeleteRecomendation extends HttpServlet {
    ...
    throws ServletException, IOException, SQLException {
        ...
        try {
           ...
           ServicioUsuarios.deleteRecomendation(login,pathResource);
           
              
           
        	
        //	request.setAttribute("favoritesDPR", favoritesDPR); 
           request.setAttribute("mensajeUsuario", "Tus recomendacion ha sido eliminada. !Tus recomendaciones han cambiado.!");
	       rd=request.getRequestDispatcher("aviso.jsp");
