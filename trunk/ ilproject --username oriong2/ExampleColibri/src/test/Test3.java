...
public class Test3 implements StandardCBRApplication
{
	...
	StandardCBRApplication recommender = new Test3();
	try
	{
		((Test3)recommender).oNewsList = GetNews.GetCasesFromDB();
	...
	{
	    org.apache.commons.logging.LogFactory.getLog(Test3.class).error(e);
