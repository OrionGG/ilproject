...
public class DiscUtil {
	 ...
	 */
	public static String getSubmissionUrl(Disc disc, String host, int port)
	{
		String netloc;
		if (port == 80){ 
			netloc = host;
		...
		String toc = disc.getFirstTrackNum()
			+ "+" + disc.getLastTrackNum()
			+ "+" + disc.getSectors();
		...
		return "http://" + netloc + "/bare/cdlookup.html?id=" + disc.getDiscId()
			+ "&toc=" + toc + "&tracks=" + disc.getLastTrackNum();
	}
	 ...
	 */
	public static Disc readDisc(String deviceName) throws NotImplementedException, DiscError
	{
	 ...
	 * @return
	 */
	public String calculateID(Disc disc){
		String id = null;
